...
| `gradeK-beats.html`, `grade1-beats.html` … `grade12-beats.html` | Grammar Beats for each grade: five-minute chant sessions, a "Name That …" projector game for every beat, a click-track metronome, and Spanish transfer notes. Grade 5 has 26 beats (one per standard) plus songs; every other grade has 8 or 9 beats (one per reporting sub-category) |
